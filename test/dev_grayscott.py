...
# https://www.youtube.com/watch?v=xL1kjpBqRNQ
...
Du=np.linspace(0.20,0.12,n)[None,:]
Dv=np.linspace(0.10,0.05,n)[None,:]
...
fig = plt.figure(figsize=figsize, dpi=dpi, facecolor="white",num=3)
