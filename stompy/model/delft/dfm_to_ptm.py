...
class DFlowToPTMHydro(object):
    ...
    def open_dflow_output(self):
        ...
        self.mod_map_ds=self.map_ds.rename({'time':'nMesh2_data_time',
    ...
    def template_ds(self):
        ...
        for fld in ['nodes','cells']:
            self.g.edges[fld][to_flip] = self.g.edges[fld][to_flip][:,::-1]
    ...
    def write_time_steps(self):
        ...
        for ti,t in enumerate(times):
            ...
            cell_water_depth=self.map_ds.mesh2d_waterdepth.isel(time=ti)
...
DFlowToPTMHydro(mdu_path,'dfm_ptm_hydro2.nc')
