...
# Row: 20
# Row: 21
# Failed to find face to flip
# cNbr: 112261 looking for ~fIdx:-347329 in  [    -27850     346333    -347456    -348686 2147483647 2147483647
...
# without njit, appears to be the exact same error
# check mesh after columns, before rows:

# Potential errors in numba version:
#  places where a summation was replaced by staring with the first entry and then
#    in-place addition. Can lead to modifying the first entry
#  append operations that lead to two List items referring to the same numpy array.
